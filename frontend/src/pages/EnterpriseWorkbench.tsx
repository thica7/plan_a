    ...
    <div className="concept-workbench-grid">
      <div className="concept-main-column">
        <div className="concept-summary-grid">
          ...
          <CoverageHeatmap claims={claims} competitors={competitors} evidence={evidence} />
  ...
  return (
    <>
      ...
      {dimensions.map((dimension) => {
        ...
        return <span className={`heat-cell ${level}`} key={`${competitor.id}-${dimension}`} title={`${competitor.name} / ${dimension}: ${count}`} />;
      })}
    </>
  );
}

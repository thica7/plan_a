...
RecordWithIdT = TypeVar("RecordWithIdT", bound=_RecordWithId)
...
def _report_release_gate_scope(
    version: ReportVersionRecord,
    *,
    project: ProjectRecord,
    store: EnterpriseStore,
    ...
    competitors = _report_scope_competitors(
        version,
        project=project,
        store=store,
        evidence=evidence,
...
def _report_scope_competitors(
    ...
    *,
    ...
    scoped_ids = _report_scope_competitor_ids(version, evidence=evidence, claims=claims)
...
def _report_scope_competitor_ids(
    version: ReportVersionRecord,
    *,
    evidence: list[EvidenceRecord],
    claims: list[ClaimRecord],
